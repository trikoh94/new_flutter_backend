...
def main():
    ...
    with tab6:
        ...
        st.markdown("""
        ### Data Flow
        - **Firebase Realtime DB**: Primary data source
        - **Data Collector**: Handles real-time and batch data collection
        - **Data Storage**: Manages processed data
        - **Analytics Engine**: Performs data analysis
        - **Dashboard**: Visualizes insights and predictions
        
        ### Storage Architecture
        - **Primary Storage**: Firebase Realtime DB
        - **Data Layer**: Manages data access
        - **Local Cache**: Improves performance
        - **Analysis Storage**: Stores processed data
        - **Visualization Cache**: Optimizes dashboard rendering
        
        ### ETL Process
        - **Extract**: Collects data from Firebase
        - **Transform**: Cleans and normalizes data
        - **Load**: Stores processed data
        - **Analysis**: Generates insights
        - **Visualization**: Creates interactive dashboards
        
        ### Analytics Pipeline
        - **Data Input**: Raw data collection
        - **Analytics Engine**: Core processing
        - **KPI Analysis**: Key metrics calculation
        - **Pattern Analysis**: Behavior analysis
